# Nyaya_Sutra — Agentic Legal Intelligence Platform
...
| **Database/Auth** | Supabase | User session management and persistent state |
...
- A provisioned **Supabase** project for the frontend state/auth.
