  ...
  return (
    <div className={`flex w-full ${isAssistant ? 'justify-start' : 'justify-end'}`}>
      <div className={`flex gap-4 max-w-[90%] md:max-w-[80%] ${isAssistant ? 'flex-row' : 'flex-row-reverse'}`}>
        <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center border shadow-sm mt-1 ${isAssistant
        ...
        <div className="flex flex-col gap-2 flex-1 min-w-0">
          <div className={`px-6 py-4 rounded-2xl shadow-sm border overflow-hidden ${isAssistant
